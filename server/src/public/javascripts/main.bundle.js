...
/***/ "./src/public/javascripts/error.js":
/*!*****************************************!*\
  !*** ./src/public/javascripts/error.js ***!
  \*****************************************/
/*! namespace exports */
...
if (document.querySelector('.error')){
    (0,_helper__WEBPACK_IMPORTED_MODULE_0__.displayModal)("Please verify your email !", "error", [() => {window.location.href = `${_helper__WEBPACK_IMPORTED_MODULE_0__.URL}`}]);
}
...
const attachEditor = (classTag, document_data, editable, schema) => {
    ...
    if (document.querySelector(`${classTag}`)){
        window.view = new prosemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView(document.querySelector(`${classTag}`), {
            state : prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorState.create({
                doc: schema.nodeFromJSON(document_data),
                plugins: (0,prosemirror_example_setup__WEBPACK_IMPORTED_MODULE_5__.exampleSetup)({schema: schema})
            }),
...
const createNewEditor = (id) => {
    ...
    if (document.querySelector(".editor")){
        window.view = new prosemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView(document.querySelector(".editor"), {
            state : prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorState.create({
                doc: prosemirror_model__WEBPACK_IMPORTED_MODULE_2__.DOMParser.fromSchema(mySchema).parse(document.querySelector(".editor-content")),
                plugins: (0,prosemirror_example_setup__WEBPACK_IMPORTED_MODULE_5__.exampleSetup)({schema: mySchema})
            })
        })
    }
