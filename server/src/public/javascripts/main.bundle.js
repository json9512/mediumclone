...
const loadEditor = async (id, classTag) => {
    ...
    if (id !== "none"){
        ...
        if (document.querySelector(`${classTag}`)){
            window.view = await new prosemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView(document.querySelector(`${classTag}`), {
        ...
        if (window.location.href.indexOf("/editor") !== -1){
            ...
            if (document.querySelector(".editor")){
                window.view = await new prosemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView(document.querySelector(".editor"), {
                    state : prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorState.create({
